        ...
        <div class="min-h-[calc(100vh-112px)] flex items-center justify-center py-4">
            <form action="" method="post" class="max-w-[70%] p-3 w-full flex flex-col gap-4 backdrop-blur-[4px] bg-white shadow-sm rounded-[10px]">
                ...
                <div class="flex items-start justify-between">
                    <div>
                        <h2 class="text-[20px] font-bold text-gray-500 uppercase">Modifier le livre</h2>
                ...
                <div class="flex gap-2 flex-wrap">
                    <div class="flex flex-1 flex-col gap-2">
                        ...
                        <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" placeholder="Titre du livre" value="{{ old('titre') ?? $livre->titre }}" id="titre" name="titre">
                        @error('titre')
                    ...
                    <div class="flex flex-1 flex-col gap-2">
                        ...
                        <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('auteur') ?? $livre->auteur }}" placeholder="Nom de l'auteur" id="auteur" name="auteur">
                        @error('auteur')
                            <p class="text-red-600 text-sm font-semibold mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-2 flex-wrap">
                    ...
                    <div class="flex flex-1 flex-col gap-2">
                        ...
                        <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('categorie') ?? $livre->categorie  }}" placeholder="Science-fiction, Conte, Roman, Histoire..." name="categorie" id="categorie">
                    </div>

                    <div class="flex flex-1 flex-col gap-2">
                        <label for="date_publication" class="font-semibold text-dark">Date de publication</label>
                        <input type="date" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('date_publication') ?? $livre->date_publication  }}" name="date_publication" id="date_publication">

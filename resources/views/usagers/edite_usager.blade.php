            ...
            <div class="min-h-[calc(100vh-112px)] flex items-center justify-center py-4">
                <form action="" method="post" class="max-w-[70%] p-3 w-full flex flex-col gap-4 backdrop-blur-[4px] bg-white shadow-sm rounded-[10px]">
                    ...
                    <div class="flex justify-between items-start">
                        <div>
                            <h2 class="text-[20px] font-bold text-gray-600 uppercase">Modifier l'usager</h2>
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <div class="flex flex-1 flex-col gap-2">
                            ...
                            <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" placeholder="Votre prenom..." value="{{ old('prenom') ?? $usager->prenom}}" id="prenom" name="prenom">
                            @error('prenom')
                        ...
                        <div class="flex flex-1 flex-col gap-2">
                            ...
                            <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('nom') ?? $usager->nom }}" placeholder="Votre nom..." id="nom" name="nom">
                            @error('nom')
                                <p class="text-red-600 text-sm font-semibold mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex gap-2 flex-wrap">
                        ...
                        <div class="flex flex-1 flex-col gap-2">
                            ...
                            <input type="email" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('email') ?? $usager->email }}" placeholder="email@gmail.com" name="email" id="email">
                            @error('email')
                        ...
                        <div class="flex flex-1 flex-col gap-2">
                            ...
                            <input type="tel" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('phone') ?? $usager->phone }}" placeholder="7X XXX XX XX" name="phone" id="phone">
                            @error('phone')
                                <p class="text-red-600 font-semibold  text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex flex-1 flex-col gap-2">
                        ...
                        <input type="text" autocomplete="off" class="w-full bg-white border border-gray-200 p-2 rounded font-sans outline-none font-semibold" value="{{ old('adresse') ?? $usager->adresse }}" placeholder="Votre adresse..." name="adresse" id="adresse">
                        @error('adresse')
                            <p class="text-red-600 font-semibold  text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="flex gap-2 flex-wrap">
                        <input type="submit" value="Modifier" class="flex-1 bg-blue-500 hover:bg-blue-600 transition duration-[.3s] ease py-2 px-3 cursor-pointer  font-semibold text-white rounded">
